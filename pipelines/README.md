<p align="center">
  <img src="https://raw.githubusercontent.com/lakebrasil/data-br/main/assets/logo/wordmark.png" alt="lakebrasil" width="480"/>
</p>
...
Requires the git repo clone (`docker-compose.yml` lives at the repo root,
not in the `pip install`ed package):
```bash
...
Bem-vindo. Veja [CONTRIBUTING.md](https://github.com/lakebrasil/data-br/blob/main/CONTRIBUTING.md) pra escopo, padrões
